...
void StartScene::start()
{
	...
	m_pStartLabel = new Label("Program For Physics", "Consolas", 70, blue, glm::vec2(400.0f, 40.0f));
	m_pStartLabel->setParent(this);
	addChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("Press 1 to Start", "Consolas", 40, blue, glm::vec2(400.0f, 120.0f));
